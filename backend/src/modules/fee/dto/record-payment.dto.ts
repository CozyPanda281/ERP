...
import { IsUUID, IsNotEmpty, IsOptional, IsNumber, IsString, IsDateString, Min, IsIn, MaxLength } from 'class-validator';
...
export class RecordPaymentDto {
  ...
  @ApiPropertyOptional({ enum: ['cash', 'cheque', 'card', 'upi', 'online', 'bank_transfer', 'dd'] })
  @IsOptional() @IsString() @IsIn(['cash', 'cheque', 'card', 'upi', 'online', 'bank_transfer', 'dd']) paymentMethod?: string;
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(50) chequeNumber?: string;
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) upiId?: string;
