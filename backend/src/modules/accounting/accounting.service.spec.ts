...
describe('AccountingService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [AccountingService, { provide: DatabaseProvider, useValue: mockDb }],
    }).compile();
  ...
  describe('createAccount', () => {
    const base = () => ({ ...T, accountCode: '1000', accountName: 'Cash', accountType: 'asset' as const });

    it('should create an account', async () => {
      mockDb.setDrizzleResults(
        [],                                                                   // no duplicate
        [{ id: 'a-1' }],                                                      // insert
        [{ id: 'a-1', accountCode: '1000', accountName: 'Cash', accountType: 'asset', tenantId: T.tenantId, branchId: T.branchId }],  // select after insert
      );
    ...
    it('should reject duplicate account code', async () => {
      ...
      await expect(service.createAccount(base())).rejects.toThrow(BadRequestException);
    });
  });

  describe('findAccountById', () => {
    it('should return account', async () => {
      mockDb.setDrizzleResults([{ id: 'a-1', accountCode: '1000', accountName: 'Cash', accountType: 'asset' }]);
    ...
    it('should throw on missing account', async () => {
      mockDb.setDrizzleResults([]);
      await expect(service.findAccountById('bad')).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('findAccountsByBranch', () => {
    it('should return paginated accounts', async () => {
      mockDb.setDrizzleResults(
        [{ id: 'a-1', accountCode: '1000', accountName: 'Cash', accountType: 'asset', deletedAt: null }],
        [{ count: '1' }],
      );
  ...
  describe('createJournalEntry', () => {
    ...
    it('should create a balanced journal entry', async () => {
      mockDb.setDrizzleResults(
        ...
        [{ id: 'i-1', accountId: 'a-1', debit: '1000', credit: '0' }, { id: 'i-2', accountId: 'a-2', debit: '0', credit: '1000' }], // select items
      );
  ...
  describe('getTrialBalance', () => {
    it('should return trial balance rows', async () => {
      mockDb.setMockResult('FROM accounting_accounts a', {
        rows: [
          { id: 'a-1', account_code: '1000', account_name: 'Cash', account_type: 'asset', total_debit: '1000', total_credit: '0', balance: '1000' },
          { id: 'a-2', account_code: '2000', account_name: 'AP', account_type: 'liability', total_debit: '0', total_credit: '1000', balance: '-1000' },
        ],
      });
      const result = await service.getTrialBalance(T.branchId, '2026-01-01', '2026-12-31');
  ...
  describe('getIncomeStatement', () => {
    it('should return income statement with net income', async () => {
      mockDb.setMockResult('account_type IN', {
        rows: [
          { id: 'a-10', account_code: '4000', account_name: 'Fees', account_type: 'income', total_debit: '0', total_credit: '50000', balance: '50000' },
          { id: 'a-11', account_code: '5000', account_name: 'Salaries', account_type: 'expense', total_debit: '30000', total_credit: '0', balance: '30000' },
        ],
      });
      const result = await service.getIncomeStatement(T.branchId, '2026-01-01', '2026-12-31');
  ...
  describe('getBalanceSheet', () => {
    it('should return balance sheet with assets = liabilities + equity', async () => {
      mockDb.setMockResult('account_type IN', {
        rows: [
          { id: 'a-1', account_code: '1000', account_name: 'Cash', account_type: 'asset', total_debit: '50000', total_credit: '0', balance: '50000' },
          { id: 'a-2', account_code: '2000', account_name: 'AP', account_type: 'liability', total_debit: '0', total_credit: '10000', balance: '10000' },
          { id: 'a-3', account_code: '3000', account_name: 'Equity', account_type: 'equity', total_debit: '0', total_credit: '40000', balance: '40000' },
        ],
      });
