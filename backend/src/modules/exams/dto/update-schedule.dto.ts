...
import { IsOptional, IsString, IsNumber, IsDateString, IsUUID, Min, Max } from 'class-validator';
...
export class UpdateScheduleDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsNumber() @Min(1) @Max(1000) maxMarks?: number;
