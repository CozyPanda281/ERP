import { pgTable, uuid, varchar, text, boolean, timestamp, date, numeric, index, uniqueIndex } from 'drizzle-orm/pg-core';
...
export const expenseCategories = pgTable('expense_categories', {
  ...
  tenantNameUnique: uniqueIndex('expense_categories_tenant_id_name_key').on(table.tenantId, table.name),
}));
...
export const incomeCategories = pgTable('income_categories', {
  ...
  tenantNameUnique: uniqueIndex('income_categories_tenant_id_name_key').on(table.tenantId, table.name),
}));
