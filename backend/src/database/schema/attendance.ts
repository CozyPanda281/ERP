...
export const attendance = pgTable('attendance', {
  ...
  uniquePerDay: uniqueIndex('attendance_tenant_id_branch_id_class_id_section_id_date_key').on(table.tenantId, table.branchId, table.classId, table.sectionId, table.date),
