import { pgTable, uuid, varchar, text, boolean, smallint, time, timestamp, date, index } from 'drizzle-orm/pg-core';
...
export const timetableEntries = pgTable('timetable_entries', {
  ...
  timetableIdx: index('idx_timetable_entries_timetable').on(table.timetableId),
  dayIdx: index('idx_timetable_entries_day').on(table.timetableId, table.dayOfWeek),
}));
