...
export const planFeatures = pgTable(
  ...
  (table) => ({
    planFeatureUnique: uniqueIndex(
      'plan_features_plan_id_feature_flag_id_key',
    ).on(table.planId, table.featureFlagId),
  }),
);
...
export const tenantFeatures = pgTable(
  ...
  (table) => ({
    tenantFeatureUnique: uniqueIndex(
      'tenant_features_tenant_id_feature_flag_id_key',
    ).on(table.tenantId, table.featureFlagId),
  }),
);
