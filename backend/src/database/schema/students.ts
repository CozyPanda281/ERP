...
export const applications = pgTable('applications', {
  ...
  tenantBranchAppNoUnique: uniqueIndex('applications_tenant_id_branch_id_application_number_key').on(table.tenantId, table.branchId, table.applicationNumber),
...
export const students = pgTable('students', {
  ...
  tenantBranchAdmNoUnique: uniqueIndex('students_tenant_id_branch_id_admission_number_key').on(table.tenantId, table.branchId, table.admissionNumber),
  branchIdx: index('idx_students_branch').on(table.branchId),
  activeIdx: index('idx_students_active').on(table.branchId).where(sql`is_active = TRUE`),
...
export const studentParents = pgTable('student_parents', {
  ...
  studentParentUnique: uniqueIndex('student_parents_student_id_parent_id_key').on(table.studentId, table.parentId),
...
export const studentAcademicRecords = pgTable('student_academic_records', {
  ...
  studentAcademicYearUnique: uniqueIndex('student_academic_records_student_id_academic_year_id_key').on(table.studentId, table.academicYearId),
  studentIdx: index('idx_student_academic_records_student').on(table.studentId),
