...
export const notificationTemplates = pgTable(
  ...
  (table) => ({
    tenantCodeUnique: uniqueIndex(
      'notification_templates_tenant_id_code_key',
...
export const notificationLogs = pgTable(
  ...
  (table) => ({
    notificationIdx: index('idx_notification_logs_notification').on(
      table.notificationId,
    ),
    recipientIdx: index('idx_notification_logs_recipient').on(
      table.recipientId,
    ),
...
export const circulars = pgTable(
  ...
  (table) => ({
    tenantBranchCircularNoUnique: uniqueIndex(
      'circulars_tenant_id_branch_id_circular_number_key',
    ).on(table.tenantId, table.branchId, table.circularNumber),
  }),
);
